...
import { LOAD_MORE_MY_TODO_PROPOSALS, REFRESH_MY_TODO_PROPOSALS } from '../actions/myTodoProposals';
...
export default function (state: State = initialState, action: Action): Proposal[] {
  if (action.type === REFRESH_MY_TODO_PROPOSALS) {
    return {
      ...state,
  ...
  if (action.type === LOAD_MORE_MY_TODO_PROPOSALS) {
    return {
      ...state,
